...
function video() {
  return (
    <div className=' relative h-[55vh] w-screen top-0 left-0   bg-cover overflow-hidden  '>
      ...
      <div className='absolute top-[40%]  right-[30%]  flex flex-col md:justify-center '>
        ...
        <Link to="./component/Email" className= 'w-[40%] py-5 px-2  text-sm text-center text-purple-600 font-semibold rounded-full border border-purple-200 hover:text-white hover:bg-purple-600 hover:border-transparent focus:outline-none focus:ring-2 focus:ring-purple-600 focus:ring-offset-2'>Lets Go</Link>
      </div>
    </div>
  )
}
