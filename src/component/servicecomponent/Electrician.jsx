...
import Barber from '../../assets/electrician.mp4'
  ...
  return (
    ...
    <div className='flex justify-center flex-col items-center'>
      <div className='w-screen h-[50vh] flex justify-evenly'>
        ...
        <h1 className='text-2xl p-5 font-bold'>ELECTRICIAN </h1>
      ...
      <div className='w-[80%] h-[15vh]  border-b-4 border-t-2 grid '>
       ...
       <Link>Packages</Link>
        <Link>Switch and Outlet Repair/Installation</Link>
        <Link>Massage</Link>
        <Link>Electrical Panel Upgrades</Link>
        <Link>Wiring and Rewiring</Link>
       </div>
      </div>
      <div className='w-[80%] h-full flex pt-10 '>
          <div className='w-[70%]'>
            <h1 className='flex justify-center pb-6 font-bold text-xl'>Packages</h1>
            <Itemsprops icon={<FcPaid/>} navname='PACKAGES' name="Electric wiring" nameicon={<FaStar/>} users='4.83(942.5k)' money='₹5900'/>
            <Itemsprops icon={<FcPaid/>} navname='PACKAGES' name="Installation of electrical instruments" nameicon={<FaStar/>} users='4.83(942.5k)' money='2000'/>
            <Itemsprops icon={<FcPaid/>} navname='PACKAGES' name="Earthing" nameicon={<FaStar/>} users='4.83(942.5k)' money='₹1900'/>
            <Itemsprops icon={<FcPaid/>} navname='PACKAGES' name="Electrical upgrades" nameicon={<FaStar/>} users='4.83(942.5k)' money='₹9900'/>
