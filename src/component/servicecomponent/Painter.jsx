  ...
  return (
    <div className='flex justify-center flex-col items-center'>
      <div className='w-screen h-[50vh] flex justify-evenly'>
        ...
        <h1 className='text-2xl p-5 font-bold'>Painter</h1>
         <div className='hover:scale-105 duration-300'>
            ...
            <p>( service taken by 1.5 M peoples )</p>
          </div>
        </div>
      ...
      <div className='w-[80%] h-[15vh]  border-b-4 border-t-2 grid '>
       ...
       <Link>Packages</Link>
        <Link>Exterior House Painting</Link>
        <Link>Massage</Link>
        <Link>Cabinet Painting</Link>
        <Link>Power Washing</Link>
       </div>
      </div>
      <div className='w-[80%] h-full flex pt-10 '>
          ...
          <div className=''>
           ...
           <h2 className='text-xl font-bold'>Power Washing + Exterior House Painting+ Interior House Painting</h2>
            <div className='flex'>
